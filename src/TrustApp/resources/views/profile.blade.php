                    ...
                    <form method="POST" action="{{ route('profile.update') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="email">Username<span class="small text-danger">*</span></label>
                                        <input type="username" id="username" class="form-control" name="username" placeholder="example" value="{{ old('username', Auth::user()->username) }}">
                                    </div>
                                </div>
                            </div>
